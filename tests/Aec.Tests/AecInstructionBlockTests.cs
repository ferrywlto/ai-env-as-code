...
public sealed class AecInstructionBlockTests
{
    ...
    public void UsesTheExistingCrLfStyleForTheManagedBlock()
    {
        ...
        var expectedBlock = LatestLf.ReplaceLineEndings("\r\n");
    ...
    [Fact]
    public void OlderVersionIsReplacedInPlaceWithoutChangingOtherBytes()
    {
        var original = Utf8(
            "prefix\r\n<!-- AEC:BEGIN version=0 -->\r\nold\r\n<!-- AEC:END -->\r\nsuffix\r\n");
